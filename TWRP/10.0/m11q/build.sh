...
if [ -f "$THIS_DIR/TWRP/out/target/product/m11q/recovery.img" ]; then
...
📍 ***Tags***: #m11q #twrp #10 #dynamic"
~/tmp/telegram -f "$THIS_DIR/TWRP/out/target/product/m11q/recovery.img" ""
else
   # Error in build
~/tmp/telegram -M "⚒ ***Recovery***: [TWRP](https://github.com/TeamWin) (10.0)
📱 ***Device***: Samsung Galaxy M11
