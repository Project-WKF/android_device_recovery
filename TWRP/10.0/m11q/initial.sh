...
git clone https://github.com/Velosh/android_kernel_samsung_m11q -b master kernel/samsung/m11q --depth 1
git clone https://github.com/Velosh/android_device_samsung_m11q -b twrp-10.0 device/samsung/m11q --depth 1
